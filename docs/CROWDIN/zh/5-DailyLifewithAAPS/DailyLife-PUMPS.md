...
長時間斷線（1 - 2 小時）後，**AAPS** 通常會計算出您現在有負的 IOB。 當您重新連線幫浦時，根據偏好設定/當前血糖值/計劃的食物或後續活動，您可以選擇： When you reconnect the pump, depending on preference/current glucose level/planned food or subsequent activity, you can either:
